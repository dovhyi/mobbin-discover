...
export default function QueryHelper({ onQueryClick }: { onQueryClick: (q: string) => void }) {
  ...
  return (
    <div
      className={`fixed right-[var(--container-x-padding)] top-[72px] z-40 hidden w-[320px] flex-col gap-y-[12px] rounded-[20px] border border-[var(--border)] bg-[var(--overlay)] p-[16px] shadow-[0px_12px_48px_rgba(0,0,0,0.12)] backdrop-blur-[24px] transition-all duration-200 ease-out min-[1160px]:flex ${
